...
var Desk = (function (_super) {
    ...
    Desk.prototype.drawDesk = function () {
        ...
        desk.addEventListener(egret.TouchEvent.TOUCH_MOVE, function (e) { return console.log(e); }, this);
        desk.addEventListener(egret.TouchEvent.TOUCH_TAP, function (e) { return console.log(e); }, this);
        // desk.addEventListener(mouse.MouseEvent.MOUSE_OUT, (e) => console.log(e), this);
        var rect = Utils.drawRect(0x0000ff, [250, 240, 250, 150]);
        console.log(rect);
        var roundRect = Utils.drawRoundRect(0x0000ff, [400, 400, 100, 100, 20, 20]);
        this.addChild(rect);
